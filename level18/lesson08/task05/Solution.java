...
public class Solution {
    public class TableInterfaceWrapper implements ATableInterface {
        ...
        public String getHeaderText(){return original.getHeaderText().toUpperCase();}

        public void setHeaderText(String newHeaderText){original.setHeaderText(newHeaderText);}
