...
вторым именем. Если файла, который необходимо скопировать, и имя которого вводится
первым, нет, то программа должна вывести надпись «Файл не существует.» и еще раз
