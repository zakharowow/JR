...
public class Solution {
    ...
    public static class MarkTwainBook extends Book{
        ...
        MarkTwainBook(String book){super("Mark Twain"); this.book = book;}

        public MarkTwainBook getBook(){return this;}

        public String getName(){return this.book;}
    }
    ...
    public static class AgathaChristieBook extends Book{
        ...
        AgathaChristieBook(String book){super("Agatha Christie"); this.book = book;}
